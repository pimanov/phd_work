...
\usepackage{wrapfig}
\setlist[enumerate]{nosep,labelindent=2mm,label=\arabic*.,labelwidth=\widthof{\ref{last-item}},itemindent=6mm,leftmargin=5mm}
...
%\usepackage[style=gost-numeric, backend=biber, %language=auto,
%  hyperref=auto,  autolang=other, sorting=none, movenames=false, %bibencoding=auto, %babel=other
%]{biblatex}
%\usepackage{csquotes}
...
\graphicspath{{fig/}, {../ch2_figures/}, {../ch3_figures/}}
